  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_API_URL}/product/add`,
        {
          name: addName,
  ...
  const updateUserStatus = async (userId, status) => {
    ...
    try {
      const response = await axios.put(
        `${import.meta.env.VITE_BACKEND_API_URL}/product/updateStatus`,
        {
          id: userId,
          status: status,
        },
  ...
  const deleteProduct = async (deleteID) => {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_BACKEND_API_URL}/product/delete/${deleteID}`,
        config
      );
