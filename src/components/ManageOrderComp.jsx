...
const ManageOrderComp = (args) => {
  ...
  const fetchProductDetails = async () => {
    const apiUrl = `${import.meta.env.VITE_BACKEND_API_URL}/product/get`;
  ...
  const getProductByCategory = async (prodCat) => {
    const apiUrl = `${
      import.meta.env.VITE_BACKEND_API_URL
    }/product/getByCategoryID/${prodCat}`;
  ...
  const getProductInfoById = async (productId) => {
    ...
    try {
      ...
      setProdPrice(response.data.data.price);
  ...
  const generateReport = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_API_URL}/bill/generateReport`,
        {
          phone_number: addContact,
          email: addEmail,
          name: addName,
  ...
  const generatePdf = async (
    ...
    try {
      ...
      console.log("API DATA", response.data);
      downloadPdf(response.data.data, uuid);
    } catch (error) {
      console.error(error);
    }
  };
